...
qui foreach scenario in "none" "Male" "Female" "White" "Nonwhite" "WhiteMale" "WhiteFemale" "NonwhiteMale" "NonwhiteFemale" {

	* Scenarios suppressed due to confidentiality
	if inlist("`scenario'","White","Nonwhite","WhiteMale","WhiteFemale","NonwhiteMale","NonwhiteFemale") continue
	...
	* Save the data
	...
	save "$Driving/data/add_health/derived/addhealth_`output_fn'.dta", replace
}	
